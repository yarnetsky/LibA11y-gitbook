...
Tota11y can be used in any desktop browser. Simply grab and drag the link from the box below into your bookmarks bar.
...
2. Click the Tota11y bookmark you just installed.
3. Click on the black x-ray glasses icon which will now appear at the bottom left corner of your page \(screenshot above\).
